...
// export default () => (
const CourseTopRollEnquery = () => (
  <StaticQuery
    query={graphql`
      query CourseTopRollEnQuery {
        allMarkdownRemark(
    ...
    `}
    render={(data) => <CourseTopRollEn data={data} />}
  />
);

export default CourseTopRollEnquery;
