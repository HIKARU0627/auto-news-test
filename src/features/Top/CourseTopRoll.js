...
// export default () => (
const CourseTopRollquery = () => (
  <StaticQuery
    query={graphql`
      query CourseTopRollQuery {
        allMarkdownRemark(
    ...
    `}
    render={(data) => <CourseTopRoll data={data} />}
  />
);

export default CourseTopRollquery;
