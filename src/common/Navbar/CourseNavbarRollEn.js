...
const CourseNavbarRollEn = (props) => {
  const { data } = props;
...
// export default () => (
const CourseNavbarRollEnquery = () => (
  <StaticQuery
    query={graphql`
      query CourseNavbarRollEnQuery {
        allMarkdownRemark(
    ...
    `}
    render={(data) => <CourseNavbarRollEn data={data} />}
  />
);

export default CourseNavbarRollEnquery;
