      ...
      <div className="modal is-active">
        ...
        <div className="modal-card">
          ...
          <footer className="modal-card-foot">
            <form
              name="contact"
              action="https://formspree.io/f/xrgdrvpz"
              method="POST"
            >
              <input
                type="hidden"
              ...
              />
              <input type="hidden" name="あなたは" value={data.Question2} />
              <input
                type="hidden"
                name="お住まいの都道府県"
            ...
            <div className="button" onClick={() => setModalOpen(false)}>
              閉じる
            </div>
          </footer>
        </div>
        ...
        <div className="container">
          <div className="section">
            <div className="content">
              <p>
                「名大の授業」についてのお問い合わせは以下のフォームからお願いします。
              </p>
