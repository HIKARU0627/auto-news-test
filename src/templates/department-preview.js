...
export const DepartmentTemplatePreview = ({
  content,
  contentComponent,
  title,
  subtitle,
...
DepartmentTemplatePreview.propTypes = {
...
// const Department = ({ data, pageContext }) => {
...
//   query DepartmentsByID($id: String!, $department: String) {
